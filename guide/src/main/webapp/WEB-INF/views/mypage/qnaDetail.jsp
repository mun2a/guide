					...
					<div class="card-body px-5 py-3 p-sm-5">
						<h2 class="card-title text-center mb-5 fw-bold fs-2">문의글</h2>
						    <div class="form-group row mb-3">
						      ...
						      <div class="col-sm-10">
						        <input type="text"  class="form-control bg-white pe-none" value="${qnaInfo.qna_title ne '1' ? qnaInfo.qna_title ne '2' ? '기타 문의' : '일정 문의' : '계정 문의'} " readonly="readonly" maxlength="30">
						      </div>
						    </div>
						    <div class="form-group row mb-3">
						      <label for="member_name" class="col-sm-2 col-form-label fw-bolder">작성자</label>
						      <div class="col-sm-10">
						        <input type="text"  class="form-control bg-white pe-none" value="${empty qnaInfo.qna_write_name ? '비회원' : qnaInfo.qna_write_name}" readonly="readonly">
						      </div>
						    </div>
						    <div class="form-group row mb-3">
						      <label for="board_contents" class="col-sm-2 col-form-label align-middle fw-bolder" >글 내용</label>
						      <div class="col-sm-10">
						        <textarea class="form-control bg-white" name="qna_content" rows="10" readonly="readonly" style="resize: none;" maxlength="1300">${qnaInfo.qna_content}</textarea>
						      </div>
						    </div>
						    ...
						    <sec:authorize access=" isAnonymous()">
								<div class="w-100">
									<a href="javascript:history.go(-1)" class="w-50">
							  	 	...
							  	 	<c:choose>
							  	 		<c:when test="${principal.username eq qnaInfo.qna_write}">
							  	 			<div class="hstack gap-3 w-75 ms-auto">
												...
												<button class="btn btn-dark fw-bold w-50 qnaRemove " data-qna_no = "${qnaInfo.qna_no }">글 삭제</button>
												<a href="javascript:history.go(-1)" class="w-50">
							  	 		...
							  	 		<c:otherwise>
							  	 			<div class="hstack gap-3 ">
							  	 				<input type="button" value="댓글등록" class="btn btn-dark fw-bold sub-hover" id="btn-reply-add">
												<a href="javascript:history.go(-1)" class="w-50">
													<input type="button" value="목록보기" class="btn btn-dark fw-bold " style="float: right;">
												</a>
											</div>
							  	 		</c:otherwise>
							  	 	</c:choose>
							  	 	...
							  	 	<c:choose>
							  	 		<c:when test="${principal.username eq qnaInfo.qna_write}">
							  	 			<div class="hstack gap-3 float-end">
												<button class="btn btn-dark fw-bold qnaRemove" data-qna_no = "${qnaInfo.qna_no }">글 삭제</button>
							  	 		...
							  	 		<c:otherwise>
							  	 			<div class="w-100">
												<a href="javascript:history.go(-1)" class="w-50">
													<input type="button" value="목록보기" class="btn btn-dark fw-bold sub-hover w-25" style="margin-left: 75%">
												</a>
											</div>
							  	 		</c:otherwise>
							  	 	</c:choose>
